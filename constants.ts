...
export const courses: Course[] = [
  {
    ...
    icon: ToolsIcon,
    topics: [
      'Kit de Chaves de Precisão (Philips, Pentalobe, Torx, etc.)',
      'Espátulas Plásticas e Metálicas',
      'Ventosa de Sucção para Telas',
      'Estação de Ar Quente (Retrabalho)',
      'Fonte de Alimentação Assimétrica',
      'Multímetro Digital',
      'Pinças de Precisão (Reta e Curva)',
      'Manta Antiestática (ESD)',
      'Pulseira e Luvas Antiestáticas (ESD)',
      'Álcool Isopropílico e Escovas de Limpeza',
      'Microscópio USB ou Estereoscópio',
      'Cuba Ultrassônica para Desoxidação',
    ],
  },
  {
    id: 'screen',
